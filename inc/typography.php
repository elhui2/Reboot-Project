...
function integer_lite_customize_register($wp_customize)
{
	...
	$wp_customize->add_section('upgrade', array(
		'title' => __('General Styles', 'integer'),
		'priority' => 300,
	...
	$wp_customize->add_control(
		new Integer_Customize_Control_Message(
			...
			'layout',
			array(
				'label' => __('2. Typography', 'integer'),
				'section' => 'upgrade',
				'settings' => array(),
				'description' => __('We are taking the fonts from Google Fonts®.', 'integer'),
			)
		)
	);


	$wp_customize->add_setting('rbpj_main_typography', array(
		'default'           => __('Inconsolata', 'integer'),
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'custom_title_text',
			array(
				'label'    => __('Main Font Family', 'integer'),
				'section'  => 'upgrade',
				'settings' => 'rbpj_main_typography',
				'type'     => 'text'
			)
		)
	);
